...
• Mentored 15+ capstone teams comprising 60 students per semester across embedded, ML, and robotics projects; led design reviews and milestone planning.
• Created debugging playbooks and hands-on labs for ROS, microcontrollers, and CI; unblocked teams on software–hardware integration issues.
• Designed and maintained the course site (Python/HTML/CSS/JS) and automated student–project mapping aligned to each project description based on resume.
